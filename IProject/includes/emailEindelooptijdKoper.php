...
*/
function emailEindeLooptijdKoper($veiling)
{
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <br>
                      <p>Er is een veiling verwijderd waar u het hoogst op heeft geboden.
                      </p>
                      <p>Het gaat om de volgende veiling: <br>
