<?php
function EmailVerwijderdHoogstebod($veiling)
{
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <br>
                      <p>'.$veiling[1]['gebruikersnaam'].' heeft een veiling verwijderd waar u het hoogst op heeft geboden. </p>
                      <br>
                      <p>Voorwerpnr: '.$veiling[2]['voorwerpnr'].'<br>
                         Titel: '.$veiling[2]['titel'].'<br>
                         <p>
                      <br>
                      <p>Neem contact op met de verkoper via <br>
