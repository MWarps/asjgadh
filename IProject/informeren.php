<?php include 'includes/header.php' ?>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <p>EenmaalAnderMaal is een site die het verkopen van uw tweedehands spullen makkelijker maakt. Op deze webpagina wordt een korte uitleg gegeven over hoe de website werkt.</p>
            </div>
        </div>
        ...
        <div class="row mt-3 mb-3">
            <div class="col-md-7">
                ...
                <p> Om een specifiek product op te zoeken staat er boven aan de website een zoekbalk. In het eerste veld vult u de productnaam in. In het tweede veld vult u de rubriek in
                    waar je het item in wilt zoeken. Het derde veld vult u uw postcode in. In het vierde veld vult u het aantal kilometers in waarin u wilt zoeken. Hierna wordt u naar een
                    nieuwe pagina gebracht waar u een selectie krijgt te zien van alle producten die binnen uw zoekopdracht vallen. Klik op de foto van het product om op de aanbod pagina te komen.
                </p>
            </div>
            <div class="col-md-5">
