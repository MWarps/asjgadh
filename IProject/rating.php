...
if(isset($_GET['id'])){
  $recentie = bestaatRecentie($_GET['id']);
  $_SESSION['voorwerpnr'] = $_GET['id'];
  if(!empty($recentie)) {
...
if(isset($_POST['volgende'])){
    ...
    updateRecentie($_SESSION['voorwerpnr'], $waarde, $_SESSION['vekoper']);
        ...
        <div class="col-md-6 mt-4">
            <div class="card">
                <div class="card-header">
                    <h1>Beoordelinging van <?php echo $_SESSION['vekoper']; ?></h1>
                    <div class="card-body">
                        <p>Beoordeel de algemene ervaring met <?php echo $_SESSION['vekoper']; ?> </p>
