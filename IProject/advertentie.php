        ...
        <div class="row">
            <div class="col-md-3">
                <form class="needs-validation" novalidate
                      action='advertentie.php?id=<?php echo $advertentie['voorwerpnr'] ?>' method="post">
                    <div class="form-row">
                        <?php if (!empty(zijnErBiedingen($advertentie['voorwerpnr']))) {
                            ...
                            $hoogstebod = $advertentie['startprijs'];
                            $hoogstebod1 = number_format($advertentie['startprijs'], 2, ',', '.');
                        }
                        ?>
                        <label for="bod">Bieden: (vanaf: €<?php echo $hoogstebod1; ?>)</label>
                        <input type="number" name="bod" class="form-control mt-3 mb-3" id="bod" step="0.01"
                               max="999999.99" min="<?php echo $hoogstebod; ?>"<?php if ($bieden) {
                            echo 'required';
                        } else {
                            echo 'readonly';
                        } ?> >
                        ...
                        <?php if ($bieden) {
                            echo '<button class="btn btn-lg btn-primary mt-3 mb-3" type="submit" name="bieden" value="bieden"> Plaats bod </button>';
                        } ?>
                    </div>
                </form>
            </div>
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary btn-lg mt-3"><a style="color: white;"
                                                                                     href="stuurbericht.php?id=<?php echo $advertentie['verkoper'] ?>">Stuur
                                bericht!</a></button>
                    </div>
                </div>
                <hr>
                <div class="icon-product">
                    ...
                    sinds <?php echo date("d.m.Y H:i", strtotime($advertentie['looptijdbegindagtijdstip'])); ?> <br><br>
                    <img src="assets/img/betalingswijze.png"> betalingswijze:
                    ...
                    <img src="assets/img/voorwerp.png"> Voorwerpnummer:
                    <strong><?php echo $advertentie['voorwerpnr'] ?></strong>
                </div>
            </div>
        </div>
    </div>
